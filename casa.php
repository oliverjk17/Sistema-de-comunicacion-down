...
<body>
    ...
    <h1>Juego de union de objetos del Baño: Nivel 2</h1>
        <div class="row">
            <div class="item-container" id="item1">
                <img src="imagenes/Cama.png" alt="Imagen 1" class="item-image">
            </div>
            <div class="item-container" id="item2">
                <img src="imagenes/Toalla.png" alt="Imagen 2" class="item-image">
            </div>
            <div class="item-container" id="item3">
                <img src="imagenes/Baño.png" alt="Imagen 3" class="item-image">
            </div>
            <div class="item-container" id="item4">
                <img src="imagenes/Almohada.png" alt="Imagen 4" class="item-image">
            </div>
        </div>
    ...
    <script>
        ...
        function redirigir() {
            window.location.href = 'transportes.php'; // Cambia 'otro.html' por la ruta a tu otro archivo HTML
        }
