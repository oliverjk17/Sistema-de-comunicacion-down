const images = [
    { src: 'fonemas/fonemaP/pelota.png', audio: 'fonemas/fonemaP/pelota.mp3', phoneme: 'P' },
    { src: 'fonemas/fonemaP/perro.png', audio: 'fonemas/fonemaP/Perro.mp3', phoneme: 'P' },
  
 
    { src: 'fonemas/fonemaL/libro.png', audio: 'fonemas/fonemaL/libro.mp3', phoneme: 'L' },
    { src: 'fonemas/fonemaL/limon.png', audio: 'fonemas/fonemaL/limon.mp3', phoneme: 'L' },
   
    
    { src: 'fonemas/fonemaR/risa.png', audio: 'fonemas/fonemaR/risa.mp3', phoneme: 'R' },
    { src: 'fonemas/fonemaR/ropa.png', audio: 'fonemas/fonemaR/ropa.mp3', phoneme: 'R' },
...
document.querySelector('.btn-siguiente').addEventListener('click', function() {
    ...
    xhr.send(`id_usuario=${usuarioId}&id_modulo=2&id_juego=5&progreso_usuario=${correctImagesCount}`);
