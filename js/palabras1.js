...
const ordenCorrecto = ["Imagen 1", "Imagen 3", "Imagen 2"];
let ordenActual = [];
...
document.getElementById('navigateButton').addEventListener('click', function () {
    ...
    const id_juego = 7;  // id del juego fijo ACA LO TENGO QUE CAMBIAR EN LOS DEMAS 
    ...
    .then(data => {
        if (data.success) {
            ...
            window.location.href = "2nivpala.php";
        } else {
