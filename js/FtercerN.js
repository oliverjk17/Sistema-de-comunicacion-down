const images = [
    { src: 'fonemas/fonemaP/pizza.png', audio: 'fonemas/fonemaP/pizza.mp3', phoneme: 'P' },
    { src: 'fonemas/fonemaP/playera.png', audio: 'fonemas/fonemaP/playera.mp3', phoneme: 'P' },
   
    { src: 'fonemas/fonemaL/lobo.png', audio: 'fonemas/fonemaL/lobo.mp3', phoneme: 'L' },
    { src: 'fonemas/fonemaL/luna.png', audio: 'fonemas/fonemaL/luna.mp3', phoneme: 'L' },

    { src: 'fonemas/fonemaR/rosa.png', audio: 'fonemas/fonemaR/rosa.mp3', phoneme: 'R' },
    { src: 'fonemas/fonemaR/ruido.png', audio: 'fonemas/fonemaR/ruido.mp3', phoneme: 'R' },
...
document.querySelector('.btn-siguiente').addEventListener('click', function() {
    ...
    xhr.send(`id_usuario=${usuarioId}&id_modulo=2&id_juego=6&progreso_usuario=${correctImagesCount}`);
