...
<body>
    <div class="container">
        <div class="title">Unión de Palabras</div>
        ...
        <div class="image-area" id="imageArea">
            <img src="palabras/quiero.png" class="draggable" alt="Imagen 1" draggable="true">
            <img src="palabras/agua.png" class="draggable" alt="Imagen 2" draggable="true">
            <img src="palabras/tomar.png" class="draggable" alt="Imagen 3" draggable="true">
        </div>
    ...
    <script src="js/palabras1.js"></script>
    <script>
