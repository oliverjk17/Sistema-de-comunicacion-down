...
<body>
    <div class="container">
        <div class="title">Unión de Palabras: Nivel 3</div>
        ...
        <img src="palabras/abajo.png" class="draggable" alt="Imagen 4" draggable="true">
            <img src="palabras/zapatos.png" class="draggable" alt="Imagen 2" draggable="true">
            <img src="palabras/ESTAN.png" class="draggable" alt="Imagen 3" draggable="true">
            <img src="palabras/los.png" class="draggable" alt="Imagen 1" draggable="true">
        </div>
    ...
    <script src="js/palabras3.js"></script>
    <script>
